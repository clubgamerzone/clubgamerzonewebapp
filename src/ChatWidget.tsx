...
const copy = {
  en: { greeting: 'Hi! Welcome to ClubGamerZone. Ask about our services, tell us about a development project, or request a quotation.', suggestions: ['Can you build my app idea?', 'Request a project quotation', 'What services do you offer?'], ready: 'Project inquiries', close: 'Close chat', thinking: 'Writing…', message: 'Your project question', placeholder: 'Tell us about your project…', send: 'Send message', disclaimer: 'For ClubGamerZone project inquiries and quotations. Our team personally confirms scope, timing, and pricing.', privacy: 'Privacy', launcher: 'Let’s talk', openLabel: 'Talk with ClubGamerZone', closeLabel: 'Close ClubGamerZone chat', fallback: 'We’re having trouble connecting right now. Please email us at admin@clubgamerzone.com or call +57 305 483 9092 and we’ll help you personally.', panel: 'Chat with ClubGamerZone' },
  es: { greeting: '¡Hola! Bienvenido a ClubGamerZone. Pregunta por nuestros servicios, cuéntanos sobre un proyecto de desarrollo o solicita una cotización.', suggestions: ['¿Pueden desarrollar mi aplicación?', 'Solicitar una cotización', '¿Qué servicios ofrecen?'], ready: 'Consultas de proyectos', close: 'Cerrar chat', thinking: 'Escribiendo…', message: 'Tu pregunta sobre el proyecto', placeholder: 'Cuéntanos sobre tu proyecto…', send: 'Enviar mensaje', disclaimer: 'Para consultas y cotizaciones de proyectos ClubGamerZone. Nuestro equipo confirma personalmente alcance, tiempos y precios.', privacy: 'Privacidad', launcher: 'Hablemos', openLabel: 'Hablar con ClubGamerZone', closeLabel: 'Cerrar chat de ClubGamerZone', fallback: 'Tenemos problemas para conectarnos en este momento. Escríbenos a admin@clubgamerzone.com o llama al +57 305 483 9092 y te ayudaremos personalmente.', panel: 'Chatea con ClubGamerZone' },
} as const;
    ...
    <div className="chat-widget">
      {open && (
        <section className="chat-panel" aria-label={c.panel}>
          ...
          <p className="chat-disclaimer">{c.disclaimer} <a href="/privacy-policy">{c.privacy}</a></p>
        </section>
      )}
