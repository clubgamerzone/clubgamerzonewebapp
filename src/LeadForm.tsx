...
const copy = {
  en: {
    ...
    thankYou: 'Your WhatsApp inquiry is ready.', received: 'WhatsApp opened with your project details. Review the message and tap Send so we can receive it.', another: 'Prepare another inquiry', kicker: 'Project inquiry', heading: 'Tell us what’s on your mind.', name: 'Your name', namePlaceholder: 'How should we address you?', email: 'Email', phone: 'WhatsApp phone (optional)', phonePlaceholder: 'Include country code, e.g. +1 555 123 4567', help: 'What can we help with?', select: 'Select a project type', idea: 'Tell us about your idea', ideaPlaceholder: 'What do you want to build, who is it for, and what would success look like?', send: 'Continue in WhatsApp', error: 'We couldn’t open WhatsApp. Please message +57 305 483 9092 or email admin@clubgamerzone.com.', privacy: 'Your details are placed in a WhatsApp message for you to review before sending.', honeypot: 'Don’t fill this out:',
  },
  es: {
